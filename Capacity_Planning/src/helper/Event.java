...
public class Event {
	...
	/**
	 * Adds a strategy and save a_T and s_T in the corresponding variable
	 * @param strategy - must be of the full length of the time horizon (so that all investment decisions are taken into account)
	 */
